...
// PEM-ANDRO-3
// 9 Juni 2024
class DailyActivityAdapter(private val shapeItems: List<DailyFragment.ShapeItem>) :
    RecyclerView.Adapter<DailyActivityAdapter.ShapeViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShapeViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.daily_card, parent, false)
